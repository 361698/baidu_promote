...
- 文档索引在本 skill 的 `index.md`（链接含 docGuid、repositoryGuid 等 ID ↔ 文档名 ↔ 作者）。每当创建、编辑、发布一篇文档，或识别到文档有更新、用户告知新文档，请把对应的「文档名、作者、链接、docGuid、repositoryGuid」追加/更新进 `index.md`；只存这几列，不写正文敏感内容。
